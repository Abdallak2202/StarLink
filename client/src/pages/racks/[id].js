...
agregarCarrito(productoSeleccionado);
 ...
 return <div>
  { entrada ?
  <div class="bg-gradient-to-br from-purple-300 via-violet-100  to-cyan-200 p-8 rounded-md w-ful pt-48 h-full pb-80">
  ...
  <div>
   ...
   <button class="bg-indigo-600 px-4 py-3 rounded-md text-white font-semibold tracking-wide cursor-pointer text-lg" id="monthly" onClick={()=>router.push('/hosting/w-hosting/webHosting')}>continue shopping</button></Link>

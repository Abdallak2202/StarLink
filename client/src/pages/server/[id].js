...
agregarCarrito(productoSeleccionado);
 ...
 return <div>
  ...
  <div>
   ...
   <button class="bg-indigo-600 px-4 py-3 rounded-md text-white font-semibold tracking-wide cursor-pointer text-lg" id="monthly" onClick={()=>router.push('/hosting/servidores-dedicados')}>continue shopping</button></Link>
    ...
    <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
       ...
       <tr>
             ...
             <p class="text-gray-900 whitespace-no-wrap">{entrada.brand}</p>
             </td>

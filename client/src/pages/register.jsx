...
const Register = () => {
  ...
  return (
    <div class="min-w-screen min-h-screen bg-gradient-to-br from-indigo-300 via-violet-100 to-sky-200 flex items-center justify-center px-28  pt-40 pb-28 shadow-3xl shadow-black">
    ...
    <div class="hidden md:block w-1/2 bg-indigo-500 py-10 px-10">
     ...
     <div class="text-center mb-28 pt-16">
        <h1 class="font-bold text-5xl text-gray-900 pb-1">REGISTER</h1>
        <p className='text-base'>Enter your information to register</p>
        </div>
        ...
        <div class="w-1/2 px-3 mb-12">
            ...
            <label class="text-xl font-semibold px-1" htmlFor="FirstName">
              First Name
            </label>
            <div class="flex">
          ...
          <div class="w-1/2 px-3 mb-12">
            <label class="text-xl font-semibold px-1" htmlFor="LastName">
             LastName
            </label>
          <div class="flex">
          <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
            <input
              ...
              <div class="w-1/2 px-3 mb-12">
            <label class="text-lg font-semibold px-1" htmlFor="Phone">
             Phone Number
            </label>
            <div class="flex">
            <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
        ...
        <label class="text-xl font-semibold px-1" htmlFor="username">
         Username
        </label>
        <div class="flex">
       ...
       <div class="w-full px-3 mb-16">
            ...
            <label class="text-xl font-semibold px-1" htmlFor="Address">
             Address
            </label>
            <div class="flex">
          ...
          <div class="flex -mx-3">
          <div class="w-full px-3 mb-16">
            <label class="text-xl font-semibold px-1" htmlFor="email">
              Email
            </label>
            <div class="flex">
            <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
          ...
          <div class="w-full px-3 mb-20">
            <label class="text-xl font-semibold px-1" htmlFor="password">
              Password
            </label>
            <div class="flex">
            <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
          ...
          <button
            class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg  py-10 font-semibold"
            type="submit"
          >
            REGISTER NOW
          </button>

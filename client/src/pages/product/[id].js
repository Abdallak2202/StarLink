...
const ProductScreen = ({entrada, agregarCarrito})=> {
   const {name, price, SSD, RAM, processor, transfer, id, description, slug, service} = entrada
...
agregarCarrito(productoSeleccionado);
 ...
 <div>
  ...
  <button class="bg-indigo-600 px-4 py-3 rounded-md text-white font-semibold tracking-wide cursor-pointer text-lg" id="monthly" onClick={()=>router.push('/cloudDedicados/cloudServers')}>continue shopping</button></Link>
   ...
   <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
      ...
      <tr>
            ...
            <p class="text-gray-900 whitespace-no-wrap">{entrada.name}</p>
            </td>

            <td class="px-5 py-5 border-b border-gray-300 bg-transparent text-lg backdrop-blur-xl">
            <p class="text-gray-900 whitespace-no-wrap">{entrada.RAM} GB</p>
            </td>

            <td class="px-5 py-5 border-b border-gray-300 bg-transparent text-lg backdrop-blur-xl">
            <p class="text-gray-900 whitespace-no-wrap">{entrada.SSD} TB</p>
            </td>
            <td class="px-5 py-5 border-b border-gray-300 bg-transparent text-lg backdrop-blur-xl">
            <p class="text-gray-900 whitespace-no-wrap">{entrada.processor} UND</p>
            </td>
            <td class="px-5 py-5 border-b border-gray-300 bg-transparent text-lg backdrop-blur-xl">
            <p class="text-gray-900 whitespace-no-wrap">{entrada.transfer} tf</p>
            </td>
            <td class="px-5 py-5 border-b border-gray-300 bg-transparent text-lg backdrop-blur-xl">
